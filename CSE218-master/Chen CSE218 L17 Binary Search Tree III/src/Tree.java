...
public class Tree {
	...
	public void insert(int id, double dd) {//perfectly balanced tree log(n)
	...
	private Node getSuccessor(Node delNode) {//first right child that has no left child, find successor is log(n)
	...
	private void inOrder(Node localRoot) {// nlog(n)
		if (localRoot != null) {
	...
	private void postOrder(Node localRoot) {// nlog(n)
		if (localRoot != null) {
